...
// atomicAdd(double*, double) is natively supported in CUDA >= 6.0 (sm_60+)
// Since we're targeting sm_80, we don't need this compatibility shim
// Original code kept here for reference but commented out to avoid conflicts with CUDA 12.x
/*
