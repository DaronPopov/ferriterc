...
Status: Active  
Scope: `internal/ptx-daemon/src/tui/**`  
...
- Primary token module: `internal/ptx-daemon/src/tui/style.rs`
...
- Shell header + status: `internal/ptx-daemon/src/tui/layout/shell/header.rs`
- Shell logs panel: `internal/ptx-daemon/src/tui/layout/shell/logs.rs`
- System/detail sections: `internal/ptx-daemon/src/tui/layout/shell/sections.rs`
- Files tree/editor/output: `internal/ptx-daemon/src/tui/layout/files.rs`
- Scheduler panel (queue/tenants/policy): `internal/ptx-daemon/src/tui/layout/scheduler.rs`
- Clean dashboard mode: `internal/ptx-daemon/src/tui/layout/clean.rs`
...
cd /home/daron/fdfd/ferriterc/ferrite-os
cargo run -p ferrite-daemon -- serve --config internal/ptx-daemon/dev-config.toml
```
