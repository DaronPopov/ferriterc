...
fn strict_mode_full_suite() {
    ...
    // ── DENY: heavy targets ──
    let heavy_targets = [
        ("jitter_benchmark", "ptx-runtime/examples/jitter_benchmark.rs#main"),
        ("candle_performance_benchmark", "ptx-runtime/examples/candle_performance_benchmark.rs#main"),
        ("fused_kernel_benchmark", "ptx-runtime/examples/fused_kernel_benchmark.rs#main"),
        ("llm_inference_demo", "ptx-runtime/examples/llm_inference_demo.rs#main"),
        ("neural_layer_inference", "ptx-runtime/examples/neural_layer_inference.rs#main"),
    ];
...
fn compute_examples_e2e() {
    ...
    let compute_entries: &[(&str, &str)] = &[
        ...
        ("simple_matmul", "internal/ptx-compute/examples/simple_matmul.rs#main"),
        ...
        ("gpu_test (tensor)", "internal/ptx-tensor/examples/gpu_test.rs#main"),
        // ── ptx-kernels: candle / kernel verification ──
        ("test_candle", "internal/ptx-kernels/examples/test_candle.rs#main"),
        ("test_candle_tlsf", "internal/ptx-kernels/examples/test_candle_tlsf.rs#main"),
        ("verify_candle_math", "internal/ptx-kernels/examples/verify_candle_math.rs#main"),
        // ── ptx-runtime: GPU memory, streams, pipelines ──
        ("dynamic_jit_allocation", "ptx-runtime/examples/dynamic_jit_allocation.rs#main"),
        ("event_driven_gpu", "ptx-runtime/examples/event_driven_gpu.rs#main"),
        ("integration_4features", "ptx-runtime/examples/integration_4features.rs#main"),
        ("massive_candle_parallelism", "ptx-runtime/examples/massive_candle_parallelism.rs#main"),
        ("memory_efficient_pipelines", "ptx-runtime/examples/memory_efficient_pipelines.rs#main"),
        ("parallel_batch_processing", "ptx-runtime/examples/parallel_batch_processing.rs#main"),
        ("transformer_attention_layer", "ptx-runtime/examples/transformer_attention_layer.rs#main"),
    ];
...
fn per_command_stream_scaling() {
    ...
    let entries: &[(&str, &str)] = &[
        ("multistream",  "ptx-runtime/examples/multistream_active_compute.rs#main"),
        ("matmul",       "internal/ptx-compute/examples/simple_matmul.rs#main"),
        ("attention",    "ptx-runtime/examples/transformer_attention_layer.rs#main"),
    ];
...
fn uncapped_child_stream_stress_test() {
    ...
    let entries: &[(&str, &str)] = &[
        ("simple_matmul",               "internal/ptx-compute/examples/simple_matmul.rs#main"),
        ("gpu_test",                     "internal/ptx-tensor/examples/gpu_test.rs#main"),
        ("test_candle_tlsf",            "internal/ptx-kernels/examples/test_candle_tlsf.rs#main"),
        ("transformer_attention_layer",  "ptx-runtime/examples/transformer_attention_layer.rs#main"),
        ("massive_candle_parallelism",   "ptx-runtime/examples/massive_candle_parallelism.rs#main"),
        ("parallel_batch_processing",    "ptx-runtime/examples/parallel_batch_processing.rs#main"),
